...
Go to [download page](https://www.mozilla.org/en-US/firefox/new/ "") or directly download it from [here](https://www.mozilla.org/en-US/firefox/download/thanks/ "").
...
Go to [download page](https://www.microsoft.com/en-us/microsoft-365/microsoft-office ""). *(Sign-in Required)*
...
Go to [download page](https://www.adobe.com/products/premiere.html ""). *(Sign-in Required)*
...
Go to [download page](https://www.spotify.com/us/download/other/ "") or directly download it from [here](https://www.spotify.com/download/windows/ ""). *(Sign-in Required)*
...
+ a network software emulator that allows the combination of virtual and real devices, used to simulate complex networks.
