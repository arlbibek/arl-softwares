...
Go to [offical download page](https://www.mozilla.org/en-US/firefox/new/ "") or directly download it from [here](https://www.mozilla.org/en-US/firefox/download/thanks/ "").

## Tor

+ a free and open-source software for enabling anonymous communication. 

Go to Tor [offical download page](https://www.torproject.org/ "") or directly download it from [here](https://www.torproject.org/dist/torbrowser/9.5.1/torbrowser-install-win64-9.5.1_en-US.exe "").
...
Download from [microsoft store](https://www.microsoft.com/en-us/p/sharex/9nblggh4z1sp "").

## Paint.net

+ a freeware raster graphics editor program.
...
Download from [microsoft store](https://www.microsoft.com/en-us/p/musicbee/9p4clt2rj1rs "").
...
+ a trialware file archiver utility

Go to [offical download page](https://www.win-rar.com/download.html?&L=0 "") or directly download it from [here](https://www.win-rar.com/postdownload.html?&f=winrar-x64-591.exe "").

*An a good lternative for winRAR is [**7-Zip**](https://www.7-zip.org/ "") (a free and open-source file archiver). But for some reasons I'm stuck with winRAR.*
...
+ a cross-platform visual simulation tool that allows users to create network topologies and imitate modern computer networks.
...
+ [Lively Wallpaper](https://rocksdanister.github.io/lively/#three "")
